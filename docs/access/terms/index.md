...
!!! note
    In addition to the acknowledgement in the publication, do not forget to add the project number (ID:XXXXXX for e-INFRA CZ and/or ID:90255 for ELIXIR-CZ) during the export of publication to the RIV system.
 
